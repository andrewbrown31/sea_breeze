...
python /home/548/ab4502/working/sea_breeze/aus2200/aus2200_sbi.py "2016-01-01 01:00" "2016-01-31 23:00" --lat1 "-45.7" --lat2 "-6.9" --lon1 "108" --lon2 "158.5" --lev_chunk "0" --lon_chunk "0" --lat_chunk "-1" --time_chunk "1" --model aus2200 --exp_id "mjo-elnino" --hgt1 "0" --hgt2 "5000"
