...
if __name__ == "__main__":
    ...
    #Load AUS2200 model level data with default chunking in height, 
    ...
    aus2200_ml = load_aus2200_variable(["ua","va"],t1,t2,"mjo-elnino",lon_slice,lat_slice,"1hr",hgt_slice=slice(0,5000),
                                       chunks={"time":chunks.time_chunk,"lev":chunks.lev_chunk,"lat":chunks.latlon_chunk,"lon":chunks.latlon_chunk})

    #Load AUS2200 surface data with default chunking
    aus2200_sfc = round_times(
        load_aus2200_variable(["vas","uas","hus"],t1,t2,"mjo-elnino",lon_slice,lat_slice,"10min",chunks="auto"),
        "10min")
    #aus2200_zmla = load_aus2200_variable(["zmla"],t1,t2,"mjo-elnino",lon_slice,lat_slice,"1hr",chunks="auto")
    ...
    #aus2200_zmla["zmla"] = aus2200_zmla["zmla"].chunk(
    ...
    #Compute SBI, chunking in time and lat-lon
    sbi = calc_sbi(
        aus2200_wind.rename({"lev":"height"}),
        angle_ds,
        subtract_mean=True,
        height_mean=False,
        height_method="static",
        #blh_da=aus2200_zmla["zmla"],
        alpha_height=0)
