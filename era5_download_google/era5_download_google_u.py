...
)["u_component_of_wind"].chunk({"time":48})

fname = "era5_mdl_u_"+pd.to_datetime(t1).strftime("%Y%m%d")+"_"+pd.to_datetime(t2).strftime("%Y%m%d")+".nc"
complevel = 9
encoding_dict = {"u_component_of_wind":{"zlib": True, "complevel": complevel}}
